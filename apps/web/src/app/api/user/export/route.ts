...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const exportPayload = {
      ...
      notice: "This file contains a complete snapshot of your data on mdfy.app. Re-import support is planned; for now this is a portable backup you fully own. Password hashes for protected docs/bundles are intentionally stripped (only a has_password flag is included).",
    };
