...
const GALLERY_SLIDES = [
  ...
  { src: "/images/hero-mcp.webp",           alt: "MCP server in Claude Code",                   title: "MCP server",          desc: "28 tools for Claude, Cursor, Windsurf, Codex.",       href: "/plugins#mcp",     linkText: "Open" },
  { src: "/images/plugin-vscode.webp",      alt: "VS Code extension with WYSIWYG and sidebar",  title: "VS Code extension",   desc: "WYSIWYG preview, cloud sync.",                         href: "/plugins#vscode",  linkText: "Open" },
