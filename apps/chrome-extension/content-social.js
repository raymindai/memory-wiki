...
(function () {
  ...
  const BLOB_DATA = "data:image/svg+xml;utf8," + encodeURIComponent(
    ...
    '<g fill="#fafafa"><path d="M36.19,21.04c-1.54,0-2.79,1.25-2.79,2.79s1.25,2.79,2.79,2.79,2.79-1.25,2.79-2.79-1.25-2.79-2.79-2.79Z"/>' +
