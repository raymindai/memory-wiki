...
// Full-bleed: the rounded tile fills the whole canvas (same size as the old
// square toolbar icons) — only the corners are rounded + transparent, so it
// reads big in the toolbar / chrome://extensions, not shrunk. The source's own
// rx=24 (on a 128 box, ~18.75%) gives the corner rounding.
const PAD = 0;
